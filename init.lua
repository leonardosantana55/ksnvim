...
--Here starts my own config

vim.keymap.set('n', '<Leader>cs', ':nohlsearch<cr>')
vim.keymap.set('n', '<Leader>ex', ':Ex<cr>')
vim.keymap.set('n', '<Leader>evs', ':vs +Ex<cr>') --explorer with vertical split
...
-- change hjkl to hujk and set l to behave like u
vim.keymap.set('n', 'u', 'k', { noremap = true })
vim.keymap.set('n', 'k', 'l', { noremap = true })
vim.keymap.set('n', 'l', ':u<cr>')

--firula pra poder modificar as teclas do netrw
